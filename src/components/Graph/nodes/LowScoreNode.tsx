...
import { User as UserIcon, TrendingUp } from 'lucide-react';
...
const LowScoreNode: React.FC<NodeProps<LowScoreNodeData>> = ({ data }) => {
  const { user, onDrop, onDragOver } = data;

  return (
    <motion.div
      className="relative rounded-2xl bg-gradient-to-br from-blue-400 to-blue-600 text-white p-5 cursor-pointer shadow-lg flex flex-col items-center justify-center select-none min-w-[180px]"
      onDrop={onDrop}
    ...
    >
      ...
      {/* Badge */}
      <div className="absolute -top-3 -right-3 bg-cyan-400 text-blue-900 rounded-full w-10 h-10 flex items-center justify-center shadow-md border-2 border-white">
